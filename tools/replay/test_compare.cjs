...
correction.flow_measurements.c2.intervals[1].lost_packets=-1;
assert.equal(C.summarize(correction,'competition').flows.c2.loss_percent,0);
assert.equal(C.summarize(correction,'competition').flows.c2.invalid_intervals,0);
correction.flow_measurements.c2.intervals[1].lost_packets=-9;
assert.equal(C.summarize(correction,'competition').flows.c2.loss_percent,null);
